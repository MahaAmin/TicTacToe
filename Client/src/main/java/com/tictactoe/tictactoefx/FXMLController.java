...
public class FXMLController implements Initializable {
    ...
    @FXML private JFXButton googleButton, facebookButton;
    ...
    @FXML private void signInButtonClicked(ActionEvent event) throws IOException
    {
        ...
        else if(usernameTF.getText().trim().isEmpty() == false)
        {  
            if(passwordTF.getText().trim().isEmpty() == false)
    ...
    */
    ...
    @FXML private void googleButtonHovered(MouseEvent event) throws IOException
    {
        if(enteredGoogleBTN)
    ...
    @FXML private void googleButtonExited(MouseEvent event) throws IOException
    {
        googleButton.setStyle("-fx-background-color: #F8327E; ");
    }

    @FXML private void facebookButtonHovered(MouseEvent event) throws IOException
    {
    ...
    @FXML private void facebookButtonExited(MouseEvent event) throws IOException
    {
        facebookButton.setStyle("-fx-background-color: #6493D0; ");
    }
